# mini-green-shopping
Mini Green Shopping - Du an CTDL by Khanh Ngoc
# 🛍️ Mini Green Shopping
...
```bash
# Compile
g++ -std=c++17 -o shopping main.cpp functions.cpp
...
```bash
g++ -std=c++17 tests/test_cases.cpp src/functions.cpp -o test
./test